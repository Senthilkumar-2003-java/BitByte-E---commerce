...
export default function PromotorDashboard() {
 ...
 <div style={{ display:'flex', alignItems:'center', gap:'12px',marginLeft: '10px' }}>
  <img 
    src={logo} 
    alt="BitByte Logo" 
    style={{ width: 50, height: 50, borderRadius: '10px', objectFit: 'contain' }} 
  />
  <span style={{ color:'#6ee7b7', fontWeight:700, fontSize:'14px' }}>🌟 Promotor Dashboard</span>
</div>
          ...
          <div style={card}>
            ...
            <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:'18px' }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'14px' }}>
                ...
                <div><label style={lbl}>Town *</label><input name="town_name" value={form.town_name} onChange={handleChange} required maxLength={100} className="pr-inp" style={inp}/></div>
                <div><label style={lbl}>City *</label><input name="city_name" value={form.city_name} onChange={handleChange} required maxLength={25} className="pr-inp" style={inp}/></div>
                <div><label style={lbl}>District *</label><input name="district" value={form.district} onChange={handleChange} required maxLength={25} className="pr-inp" style={inp}/></div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'14px' }}>
                ...
                <div><label style={lbl}>Detail</label><input name="occupation_detail" value={form.occupation_detail} onChange={handleChange} maxLength={25} className="pr-inp" style={inp}/></div>
