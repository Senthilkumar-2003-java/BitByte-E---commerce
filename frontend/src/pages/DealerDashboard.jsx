                    ...
                    {subDealers.map((d, i) => (
                      <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: '12px', padding: '16px 20px', minWidth: '190px' }}>
                          ...
                          <div style={{ color: '#f8fafc', fontWeight: 700, fontSize: '14px', marginBottom: '6px' }}>{d.first_name}</div>                  <div style={{ color: '#94a3b8', fontSize: '12px', marginBottom: '3px' }}>📞 {d.mobile_number}</div>
